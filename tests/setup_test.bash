...
assert_contains "$agent_setup" "pi_plugin='npm:@narumitw/pi-usage'" 'macOS Pi setup declares the default usage plugin'
...
assert_contains "$common_ps1" '$plugin = '\''npm:@narumitw/pi-usage'\''' 'Windows Pi setup declares the default usage plugin'
